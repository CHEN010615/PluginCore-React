          ...
          <div className={styles.headerImage}>
            ...
            <div className={styles.headerGradient}>
              ...
              <h2 className={styles.headerName}>
                {data.name} <span className={styles.headerNameEn}>{data.nameEn}</span>
              </h2>
        ...
        <div className={styles.drawerBody}>
          ...
          <section className={`${styles.section} ${styles.breedingSection}`}>
            <h4 className={styles.sectionTitleAlt}>
              <AccountTree sx={{ fontSize: 18 }} /> 繁殖指南
            </h4>
            <div className={styles.breedingChain}>
              <div className={styles.breedingSlot}>
                ...
                <span className={styles.breedingLabel}>父亲</span>
              </div>
              ...
              <div className={styles.breedingSlot}>
                ...
                <span className={styles.breedingLabel}>母亲</span>
              </div>
              ...
              <div className={styles.breedingSlotActive}>
                ...
                <span className={styles.breedingLabelActive}>{data.breeding.childName}</span>
              </div>
            </div>
          </section>
